            ...
            return _regeneratorRuntime.wrap(function _callee$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    _context5.next = 2;
                    return _sliceInstanceProperty(_context3 = self._fileLike).call(_context3, self.offset + 26, self.offset + 30).arrayBuffer();
                  ...
                  case 2:
                    ...
                    _this.reader = _sliceInstanceProperty(_context4 = self._fileLike).call(_context4, start, end).stream().getReader();
